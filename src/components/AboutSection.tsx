  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Card 1: 研究背景與核心問題 */}
        <div className="p-6 rounded-3xl bg-[#12141c]/80 border border-white/10 space-y-3">
          <div className="w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/30 flex items-center justify-center text-purple-400">
            <Layers className="w-5 h-5" />
          </div>
          <h3 className="text-lg font-bold text-white">專題研究核心假說</h3>
        ...
        <div className="p-6 rounded-3xl bg-[#12141c]/80 border border-white/10 space-y-3">
          ...
          <h3 className="text-lg font-bold text-white">中性潮流與收藏品美學</h3>
          <p className="text-xs text-slate-300 leading-relaxed">
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white/[0.02] border border-white/10 space-y-4">
        ...
        <div className="pt-2 flex flex-wrap gap-2 text-[11px] font-mono text-slate-400">
          <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10">✓ 8mm 雙層壓克力概念</span>
          <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10">✓ 4角強磁吸附結構</span>
          <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10">✓ UV 精密微浮雕印刷</span>
          <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10">✓ 台灣加工廠對接中</span>
        </div>
      </div>
